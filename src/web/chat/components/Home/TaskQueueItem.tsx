...
import { Play, Square, Clock, CheckCircle, AlertCircle, Trash2 } from 'lucide-react';
...
export function TaskQueueItem({ queue, recentDirectories, onClick, onDelete }: TaskQueueItemProps) {
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              ...
              <span>{formatTimestamp(queue.updatedAt)}</span>
              {queue.failedTasks > 0 && (
